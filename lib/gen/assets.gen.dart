...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/bankly_logo.svg
  SvgGenImage get banklyLogo => const SvgGenImage('assets/svg/bankly_logo.svg');

  /// File path: assets/svg/copy_icon.svg
  SvgGenImage get copyIcon => const SvgGenImage('assets/svg/copy_icon.svg');

  /// File path: assets/svg/credit_icon.svg
  SvgGenImage get creditIcon => const SvgGenImage('assets/svg/credit_icon.svg');

  /// File path: assets/svg/debit_icon.svg
  SvgGenImage get debitIcon => const SvgGenImage('assets/svg/debit_icon.svg');
